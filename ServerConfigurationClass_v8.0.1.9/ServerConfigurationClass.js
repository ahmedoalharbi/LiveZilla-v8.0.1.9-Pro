...
ServerConfigurationClass.prototype.addLicenseKey = function(){
    ...
    $('#alert-btn-ok').click(function() {
        ...
        if(lk.length == 23){
            ...
            lzm_commonDialog.removeAlertDialog();
			var data = '';
			if(lk == "12345-12345-12345-12345")//OPR
			data = '<?xml version="1.0" encoding="utf-8" ?><pobs><pob rm="LTE=" am="LTE=" type="T1BS" activated="dHJ1ZQ==" amount="LTE=" serial="MTIzNDUtMTIzNDUtMTIzNDUtMTIzNDU=" >AiarADJKDGFi7yq3874y</pob></pobs>';
			else if(lk == "54321-54321-54321-54321")//NBL
			data = '<?xml version="1.0" encoding="utf-8" ?><pobs><pob rm="LTE=" am="LTE=" type="TkJM" activated="dHJ1ZQ==" amount="LTE=" serial="NTQzMjEtNTQzMjEtNTQzMjEtNTQzMjE=" >BiarADJKDGFi7yq3874y</pob></pobs>';

			var xmlDoc = $.parseXML($.trim(data));
            $(xmlDoc).find('pob').each(function(){

                var lmajreq = ($(this).attr('rm')) ? lz_global_base64_decode($(this).attr('rm')) : -1; //-1
                var lmajavl = ($(this).attr('am')) ? lz_global_base64_decode($(this).attr('am')) : -1; //-1
                var ltypek = lz_global_base64_decode($(this).attr('type')); //T1BS
                ...
                else if(lz_global_base64_decode($(this).attr('activated'))=='true') // dHJ1ZQ==
                {
                    var lamount = lz_global_base64_decode($(this).attr('amount')); // LTE=
